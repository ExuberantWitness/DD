...
def MCD_OPT_CORE(MCD_AM,MCD_FRE_A,MCD_SPAN,ID_MOTOR,MCD_GEAR_RATIO,
    ...
    def first_order_equations(t, y, *args):
        ...
        PHI_inst_0, PHI_b_dot_inst_0, theta_inst_0, theta_b_dot_inst_0 = positions[0], velocities[0], positions[4], \
            velocities[4]
        FX_TOL_1, FY_TOL_1, FZ_TOL_1, MX_TOL_1, MY_TOL_1, MZ_TOL_1, A1, A2, A3 = QSM_W1.AERO_SOLVER_FLY(PHI_inst_0,
                                                                                                     PHI_b_dot_inst_0,
                                                                                                     theta_inst_0,
                                                                                                     theta_b_dot_inst_0,
                                                                                                     Coefficient_fore_A)
        ...
        PHI_inst_1, PHI_b_dot_inst_1, theta_inst_1, theta_b_dot_inst_1 = positions[1], velocities[1], positions[5], \
            velocities[5]
        FX_TOL_2, FY_TOL_2, FZ_TOL_2, MX_TOL_2, MY_TOL_2, MZ_TOL_2, A1, A2, A3 = QSM_W2.AERO_SOLVER_FLY(PHI_inst_1,
                                                                                                     PHI_b_dot_inst_1,
                                                                                                     theta_inst_1,
                                                                                                     theta_b_dot_inst_1,
                                                                                                     Coefficient_fore_B)
        ...
        PHI_inst_2, PHI_b_dot_inst_2, theta_inst_2, theta_b_dot_inst_2 = positions[2], velocities[2], positions[6], \
            velocities[6]
        FX_TOL_3, FY_TOL_3, FZ_TOL_3, MX_TOL_3, MY_TOL_3, MZ_TOL_3, A1, A2, A3 = QSM_W3.AERO_SOLVER_FLY(PHI_inst_2,
                                                                                                     PHI_b_dot_inst_2,
                                                                                                     theta_inst_2,
                                                                                                     theta_b_dot_inst_2,
                                                                                                     Coefficient_back_B)
        ...
        PHI_inst_3, PHI_b_dot_inst_3, theta_inst_3, theta_b_dot_inst_3 = positions[3], velocities[3], positions[7], \
            velocities[7]
        FX_TOL_4, FY_TOL_4, FZ_TOL_4, MX_TOL_4, MY_TOL_4, MZ_TOL_4, A1, A2, A3 = QSM_W4.AERO_SOLVER_FLY(PHI_inst_3,
                                                                                                     PHI_b_dot_inst_3,
                                                                                                     theta_inst_3,
                                                                                                     theta_b_dot_inst_3,
                                                                                                     Coefficient_back_A)
    ...
    if MAX_W_MOTOR_1<W_max or MAX_W_MOTOR_2<W_max or MAX_W_MOTOR_3<W_max or MAX_W_MOTOR_4<W_max:
        ...
        if MAX_I_MOTOR_1 < I_max or MAX_I_MOTOR_2 < I_max or MAX_I_MOTOR_3 < I_max or MAX_I_MOTOR_4 < I_max:
