...
class MultiObjectiveMixedVariableProblem(ElementwiseProblem):
    def __init__(self, **kwargs):
        vars = {
            "MCD_AM": Real(bounds=(40, 85)),
            "MCD_FRE_A": Real(bounds=(15, 65)),
            "MCD_SPAN": Real(bounds=(0.05, 0.15)),
            # "MCD_S_AR": Real(bounds=(1, 5)),
            # "MCD_TR": Real(bounds=(0.25,1.0)),
        ...
        super().__init__(vars=vars, n_obj=2, n_ieq_constr=2, **kwargs)
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        if OK_FLAP==False:
            ...
            out["G"] = [CONSTRAINT_motor_percent - 0.5,
                        1 - CONSTRAINT_maneuvering,
                        - CONSTRAINT_Engry_rest]
        # 目标固件（最小化）
