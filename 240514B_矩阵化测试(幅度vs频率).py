...
ARRAY = np.zeros((LEN_MCD_FRE_A,LEN_MCD_AM,4))



ORIGIN_EVAL_MCD = np.zeros((LEN_MCD_FRE_A,LEN_MCD_AM))
ORIGIN_EVAL_T_HOVER =np.zeros((LEN_MCD_FRE_A,LEN_MCD_AM))
ORIGIN_EVAL_T_MISSION =np.zeros((LEN_MCD_FRE_A,LEN_MCD_AM))
ORIGIN_EVAL_V_MAX =np.zeros((LEN_MCD_FRE_A,LEN_MCD_AM))



for i in range(LEN_MCD_FRE_A):
    for j in range(LEN_MCD_AM):
